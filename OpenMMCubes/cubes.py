...
from floe.api import ParallelOEMolComputeCube, parameter, ParallelMixin
...
class OpenMMminimizeDataSetCube(ParallelMixin, OERecordComputeCube):
    title = 'Minimization Cube'
    ...
    def process(self, record, port):
        try:
            ...
            packed_system = mdData.packMDData(system)
...
class OpenMMnvtDataSetCube(ParallelMixin, OERecordComputeCube):
    title = 'NVT Cube'
    version = "0.0.0"
    classification = [["Simulation", "OpenMM", "NVT"]]
    tags = ['OpenMM', 'Parallel Cube']
...
class OpenMMnptDataSetCube(ParallelMixin, OERecordComputeCube):
    title = 'NPT Cube'
    version = "0.0.0"
    classification = [["Simulation", "OpenMM", "NPT"]]
    tags = ['OpenMM', 'Parallel Cube']
