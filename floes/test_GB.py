...
from MDCubes.cubes import OpenMMminimizeCube, OpenMMNvtCube
...
minimize.set_parameters(restraints='ca_protein')
minimize.set_parameters(restraintWt=1.0)
minimize.set_parameters(implicit_solvent='OBC2')
minimize.set_parameters(nonbondedMethod='NoCutoff')
minimize.set_parameters(center=False)
...
job.add_cubes(iligs, chargelig, ligset, iprot, protset, complx, ff, minimize, ofs, fail)
