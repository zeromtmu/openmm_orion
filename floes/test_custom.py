...
from LigPrepCubes.cubes import LigandSetChargeCube, CustomCube
...
job = WorkFloe("Test Custom Data Type")
...
job.add_cubes(iligs, chargelig, iprot, complx, solvate, ff, custom, ofs, fail)
...
ff.success.connect(custom.intake)
custom.success.connect(ofs.intake)
custom.failure.connect(fail.intake)
